...
// Called by HubSpot webhook the moment a new contact is created
...
- Keep it personal, specific, and aspirational`
    ...
    const itinerary = claudeResponse.content[0].type === 'text'
...
<body style="margin:0;padding:0;background:#F7F3EE;font-family:Georgia,serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#F7F3EE;padding:40px 20px;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:0 48px 48px;text-align:center;">
            <a href="https://soleilnacre.com/inquiry" style="display:inline-block;background:#111111;color:#ffffff;text-decoration:none;padding:16px 36px;border-radius:50px;font-size:12px;letter-spacing:0.2em;text-transform:uppercase;font-family:Arial,sans-serif;">
              Refine Your Journey
            </a>
          </td>
        </tr>
    ...
    return NextResponse.json({ success: true, message: `Itinerary sent to ${email}` });
